...
arq=os.getcwd()+'\\Setembro'+'\\pares_rio_grande_normalizados.csv'
dados_normalizados = pd.read_csv(arq, engine='python',sep=',',encoding='latin-1')


arq=os.getcwd()+'\\Setembro'+'\\pares_rio_grande.csv'
...
scaler_quinta_69 = MinMaxScaler()
scaler_quinta_138 = MinMaxScaler()
...
dados['geração usina quinta_69'] = scaler_quinta_69.fit_transform(dados['geração usina quinta_69'].values.reshape(-1, 1))

dados['geração usina quinta_138'] = scaler_quinta_138.fit_transform(dados['geração usina quinta_138'].values.reshape(-1, 1))



scalers = [scaler_quinta_69, scaler_quinta_138]
...
usinas =  ['geração usina quinta_69', 'geração usina quinta_138']
nomes = ['Quinta 69kV', 'Quinta 138kV']
